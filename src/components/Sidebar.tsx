...
export function Sidebar() {
  ...
  return (
    <>
      ...
      >
        <div className="hidden lg:flex flex-col items-center gap-2 px-4 py-4 border-b border-gray-100">
          <div className="w-full flex items-center justify-center">
            <Image src="/fmipa-logo.png" alt="Logo FMIPA" width={180} height={60} className="object-contain" style={{maxHeight: 60}} />
          </div>
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 space-y-3 border-t border-gray-100 bg-white">
          {/* Role badge */}
          {role === "super_admin" && (
          ...
          {role === "admin" && (
            <div className="bg-indigo-50 border border-indigo-200 text-indigo-700 rounded-xl p-3">
              <div className="flex items-center gap-2 mb-1">
                <Shield className="w-4 h-4" />
                <span className="text-xs font-bold uppercase tracking-wide">Admin</span>
              </div>
              <p className="text-[10px] text-indigo-600">Anda dapat mengelola barang dan transaksi</p>
            </div>
          )}
